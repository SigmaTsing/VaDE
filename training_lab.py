...
class Model(Container):
    ...
    def compile(self, optimizer, loss, metrics=[], loss_weights=None,
                sample_weight_mode=None, add_trainable_weights=None,
		add_optimizer=None, **kwargs):
        ...
        # VaDE begin
        if add_trainable_weights is not None:
            self.add_trainable_weights = add_trainable_weights
            if add_optimizer is not None:
    ...
    def _make_train_function(self):
        ...
        if self.train_function is None:
            ...
            # dcgan need
            self._collected_trainable_weights = collect_trainalbe_weights(self)
            # --------
            ...
            training_updates = self.optimizer.get_updates(self._collected_trainable_weights,
                                                          ...
                                                          self.total_loss)
            # VaDE begin
            if self.add_trainable_weights is not None:
                add_training_updates = self.add_optimizer.get_updates(self.add_trainalbe_weights, self.constraints, self.total_loss)
